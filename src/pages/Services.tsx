        ...
        >
          ...
          <p className="text-gray-300 mb-10 text-xl max-w-3xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center relative z-30">
              <Link
                to="/contact"
                className="inline-flex items-center px-8 py-4 bg-gradient-to-r from-primary-500 to-accent-500 rounded-xl font-bold text-white shadow-lg hover:shadow-primary-500/25 transition-all duration-300 hover:scale-105 text-lg relative z-30 pointer-events-auto cursor-pointer"
              >
                Get Started
              </Link>
              <Link
                to="/projects"
                className="inline-flex items-center px-8 py-4 border border-white/20 rounded-xl font-bold text-white hover:bg-white/10 transition-all duration-300 hover:scale-105 text-lg relative z-30 pointer-events-auto cursor-pointer"
              >
                View Projects
              </Link>
            </div>
