    ...
    <div className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-20 max-w-4xl mx-auto px-6 text-center">
        ...
        <motion.div
          ...
          className="flex justify-center space-x-6 mb-16 relative z-30"
        >
          <Link
            to="/contact"
            className="p-3 rounded-full glass hover:shadow-neon transition-all duration-300 hover:scale-110 group pointer-events-auto cursor-pointer relative z-30"
