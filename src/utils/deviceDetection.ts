...
export const getDeviceInfo = (): DeviceInfo => {
  ...
  try {
    if (extendedNav.deviceMemory) {
      ram = extendedNav.deviceMemory; // GB
    }
    
    if (extendedNav.hardwareConcurrency) {
      cpuCores = extendedNav.hardwareConcurrency;
    }
